...
numbers_greater_than_nine = [number for number in almost_numbers if int(number) > 9]
...
last_names_longer_than_eleven_characters = [name.split()[1] for name in full_names if len(name) > 11]
print(last_names_longer_than_eleven_characters)
print(" ".join(last_names_longer_than_eleven_characters))